                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline mb-5">
                        ...
                        <div class="card-body">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8">
                                    <span class=""><?= number_format($booking['gia_tien'], 0, ',', '.') . ' VND' ?></span>
                                </dd>
                    ...
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="add-khach-hang-vao-booking&id=<?= $booking['id'] ?>" style="color: white;" class="btn btn-sm btn-success">
                                    <i class="fas fa-trash"></i> Thêm khách hàng vào tour
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
