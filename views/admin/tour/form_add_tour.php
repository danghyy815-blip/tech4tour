        ...
        <div class="tour-form-card">
            ...
            <form action="add-tour" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" name="ten_tour" class="form-control"
                        value="<?= htmlspecialchars($old['ten_tour'] ?? '') ?>">
                    <?php if (!empty($errors['ten_tour'])): ?><small
                            class="text-danger"><?= $errors['ten_tour'] ?></small><?php endif; ?>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <?php if (!empty($errors['id_danh_muc'])): ?><span
                                    class="text-danger"><?= $errors['id_danh_muc'] ?></span><?php endif; ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <?php if (!empty($errors['hinh_anh'])): ?><small
                                    class="text-danger"><?= $errors['hinh_anh'] ?></small><?php endif; ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <?php if (!empty($errors['gia'])): ?><small
                                    class="text-danger"><?= $errors['gia'] ?></small><?php endif; ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="nha_cung_cap" class="form-control"
                        value="<?= htmlspecialchars($old['nha_cung_cap'] ?? '') ?>">
                    <?php if (!empty($errors['nha_cung_cap'])): ?><small
                            class="text-danger"><?= $errors['nha_cung_cap'] ?></small><?php endif; ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
...
<div class="mb-3">
    ...
    <input type="text" name="dia_diem" class="form-control" value="<?= htmlspecialchars($old['dia_diem'] ?? '') ?>">
    <?php if (!empty($errors['dia_diem'])): ?><small
            class="text-danger"><?= $errors['dia_diem'] ?></small><?php endif; ?>
</div>
