...
<style>
    ...
    .tour-form-title { font-size: 18px; font-weight: 700; margin-bottom: 8px; }
    .form-section-title { font-weight: 600; color: #374151; margin-bottom: 6px; }
    .form-note { color: #6b7280; font-size: 13px; }
    ...
    <div class="tour-form-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <div class="form-note">Điều chỉnh thông tin tour và chính sách</div>
            </div>
        ...
        <form action="update-tour" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="ten_tour" class="form-control" value="<?= htmlspecialchars($old['ten_tour'] ?? $tour['ten_tour']) ?>">
                <?php if (!empty($errors['ten_tour'])): ?><small class="text-danger"><?= $errors['ten_tour'] ?></small><?php endif; ?>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <?php if(!empty($errors['id_danh_muc'])): ?><span class="text-danger"><?= $errors['id_danh_muc'] ?></span><?php endif; ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <?php if (!empty($tour['hinh_anh'])): ?>
                            <div class="mb-2">
                                <img src="<?= BASE_URL ?>uploads/tours/<?= $tour['hinh_anh'] ?>" alt="" class="thumb-preview">
                            </div>
                        <?php endif; ?>
                        <input type="file" name="hinh_anh" class="form-control">
                        <?php if (!empty($errors['hinh_anh'])): ?><small class="text-danger"><?= $errors['hinh_anh'] ?></small><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" name="gia" class="form-control" value="<?= $old['gia'] ?? $tour['gia'] ?>">
                        <?php if (!empty($errors['gia'])): ?><small class="text-danger"><?= $errors['gia'] ?></small><?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <?php if (!empty($errors['nha_cung_cap'])): ?><small class="text-danger"><?= $errors['nha_cung_cap'] ?></small><?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="chinh_sach_id" class="form-section-title">Chính sách áp dụng</label>
            ...
            <div class="mb-3">
                ...
                <?php if (!empty($errors['dia_diem'])): ?><small class="text-danger"><?= $errors['dia_diem'] ?></small><?php endif; ?>
            </div>
