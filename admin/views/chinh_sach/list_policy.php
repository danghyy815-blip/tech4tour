                               ...
                               <table id="example1" class="table table-bordered table-striped">
                                   ...
                                   <tbody>
                                       <?php foreach ($policies as $key => $policy) : ?>
                                           <tr>
                                               <td><?= $key + 1 ?></td>
                                               <td><a href="<?= BASE_URL_ADMIN . '?act=detail-policy&id=' . $policy['id'] ?>"><?= $policy['ten_chinh_sach'] ?></a></td>
                                               ...
                                               <td>
                                                   <button type="button" class="btn btn-primary btn-sm">
                                                       <a href="<?= BASE_URL_ADMIN . '?act=form-update-policy&id=' . $policy['id'] ?>" style="color: white;">Sửa</a>
                                                   </button>
